...
if ($password != $confirmPassword) {
    ...
    if ($conn->query($checkMailQuery)->num_rows > 0) {
        ...
        $sql = "INSERT INTO `user` (`username`, `password`, `email`, `contact_no`, `gender`, `user_type`,`district`,`address`,`zip_code`) 
        VALUES ('$username', '$password', '$email', '$contact', '$gender',3, '$district','$address', '$postalCode')";
