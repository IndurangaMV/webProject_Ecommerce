...
// 3. Write your MySQLi UPDATE statement string (matching unified user table)
...
if ($stmt) {
    ...
    if ($stmt->execute()) {
        ...
        // 5. Output the JavaScript alert window upon success and bounce back to sellerProfile
        echo "<script>
                alert('Data stored successfully!');
                window.location.href = '../views/sellerProfile.php';
              </script>";
        exit();
    } else {
